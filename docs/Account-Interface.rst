...
.. image:: images/theme_switch2.png
   :scale: 40 %
   :align: center

Most of the images in this documentation were made using dark theme. I'm a dark theme person.
...
This setting controls what syntax coloring and styles will be used when displaying code while using dark
theme. (At present there is only one codemirror theme available for the tactic light theme.)

For these changes to take effect you will need to reload any open browser tabs. If you are using tactic in single-window
mode (see below), which is the default, this means that you'll sbe starting afresh.

Here, for example is what code looks like with the material theme:

.. image:: images/dark_theme_material.png
   :scale: 25 %
